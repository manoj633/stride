...
const Dashboard = () => {
  ...
  const chartData = [
    ...
    { category: "Pending", value: totalSubtasks - completedSubtasks }
  ];
        ...
        <div className="dashboard-main">
          <header className="dashboard-header">
            <div className="header-left">
              ...
              <h1>Welcome back, {userInfo?.name?.split(' ')[0]} <span>👋</span></h1>
              <p className="subtitle">Here's what's happening with your projects today.</p>
            </div>
            <div className="header-actions">
              <button className="secondary-btn" onClick={() => navigate('/calendar')}>
                <FiCalendar /> View Calendar
              </button>
              <button className="primary-btn" onClick={() => navigate('/tasks/add')}>
          ...
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-icon goal-bg"><FiTarget /></div>
            ...
            <div className="stat-card">
              <div className="stat-icon task-bg"><FiCheckSquare /></div>
              <div className="stat-info">
            ...
            <div className="stat-card">
              <div className="stat-icon efficiency-bg"><FiActivity /></div>
              <div className="stat-info">
          ...
          <div className="dashboard-content-layout">
            ...
            <div className="focus-section">
              ...
              <div className="focus-list">
                {tasksToday.length === 0 && subtasksToday.length === 0 ? (
                  ...
                  <>
                    {tasksToday.map(task => (
                      <div key={task._id} className="focus-item" onClick={() => navigate(`/tasks/${task._id}`)}>
                    ...
                    {subtasksToday.map(st => (
                      <div key={st._id} className="focus-item subtask" onClick={() => navigate(`/subtasks/${st._id}`)}>
                        <div className={`priority-indicator ${getPriorityClass(st.priority)}`}></div>
                        <div className="focus-item-content">
            ...
            <aside className="dashboard-sidebar">
              ...
              <div className="sidebar-widget">
                ...
                <div className="milestones-list">
                  <div className="milestone-item">
                    <div className="milestone-icon"><FiClock /></div>
                  ...
                  <div className="milestone-item">
                    <div className="milestone-icon success"><FiCheckSquare /></div>
                    <div className="milestone-text">
              ...
              <div className="sidebar-promo">
                <FiTarget size={24} />
                <p>Stay focused! You're on track to complete 85% of your goals this month.</p>
              </div>
            </aside>
          </div>
        </div>
